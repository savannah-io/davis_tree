    ...
    >
      <div className="space-y-8">
        <Section icon={DocumentCheckIcon} title="Acceptance of Terms">
          <p>
            By accessing and using Davis Tree Service services and website, you
        ...
        <Section icon={BuildingOfficeIcon} title="Service Description">
          <p>
            Davis Tree Service provides tree removal services, tree trimming,
        ...
        <Section icon={ScaleIcon} title="Limitation of Liability">
          <p>
            Davis Tree Service is not liable for any indirect, incidental, or
