...
const localConfig: LocalConfig = {
  ...
  pages: {
    Home: {
      ...
      scheduleSection: {
        ...
        scheduleContent:
          "We'll get your vehicle back to its best condition with professional collision repair services.",
          ...
          services: [
            {
              ...
              description:
                "Expert repair for all types of collision damage, restoring your vehicle to pre-accident condition with precision and care.",
              icon: "WrenchScrewdriverIcon",
              iconColor: "#3b82f6",
              titleColor: "#111827",
            ...
            },
            {
              ...
              description:
                "Advanced frame repair and alignment services using state-of-the-art equipment to ensure structural integrity and safety.",
              icon: "CogIcon",
              iconColor: "#3b82f6",
              titleColor: "#111827",
              descriptionColor: "#6b7280",
            ...
            },
            {
              ...
              description:
                "Professional automotive painting with computerized color matching to restore your vehicle's original appearance.",
              icon: "PaintBrushIcon",
              iconColor: "#3b82f6",
              titleColor: "#111827",
              descriptionColor: "#6b7280",
            ...
            },
            {
              ...
              description:
                "Complete assistance with insurance claims processing, working directly with your insurance company for seamless repairs.",
              icon: "WrenchIcon",
              iconColor: "#3b82f6",
              titleColor: "#111827",
              descriptionColor: "#6b7280",
          ...
          services: [
            {
              ...
              description:
                "Comprehensive interior and exterior detailing services to restore your vehicle's showroom appearance and protect its value.",
              icon: "SparklesIcon",
              iconColor: "#3b82f6",
              titleColor: "#111827",
              descriptionColor: "#6b7280",
    ...
    Contact: {
      ...
      subtitle:
        "Have questions about collision repair? Need an estimate? We're here to help.",
      heroSubtitleColor: "#ffffff",
  ...
  description:
    "Premier auto body shop in Savannah, GA - Expert collision repair",
  contactInfo: {
    address: "2785 Buford Hwy Ste 101-C, Duluth, GA 30096",
    phone: "(770) 495-0050",
