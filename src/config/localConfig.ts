  ...
  "pages": {
    ...
    // Hero Section
      ...
      "scheduleSection": {
        ...
        "scheduleContent": "Book your appointment with our expert technicians. We'll get your vehicle back to its best condition.",
    ...
    "Services": {
      ...
      //Subtitle
      "subtitle": "Expert collision repair and auto body services. Quality work guaranteed.", 
      ...
      "expertiseCards": [
        {
          ...
          "description": "Our team consists of I-CAR Gold Class certified technicians trained to handle all makes and models with precision and care."
        },
        {
          "title": "Feature Card 2",
          "description": "We utilize state-of-the-art diagnostic equipment and repair technologies to ensure accuracy and quality in every repair."
        },
        {
          "title": "Feature Card 3",
          "description": "We prioritize OEM parts that match your vehicle's original specifications for safety, fit, and performance."
        },
        {
          "title": "Feature Card 4",
          "description": "We stand behind our work with a lifetime warranty on all repairs as long as you own your vehicle."
        }
      ],
